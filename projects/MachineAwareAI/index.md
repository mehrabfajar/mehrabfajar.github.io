...
![MachineAware AI system architecture](machineaware-architecture.svg)
...
![Manual RAG versus Context-Aware RAG evidence paths](manual-vs-context-aware.svg)
...
![Human feedback to validated case memory](feedback-memory.svg)
